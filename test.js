...
const routes = ['/', '/signup', '/dashboard', '/accounts', '/payments', '/cards', '/investments', '/settings'];
...
async function main() {
  try {
    ...
    throw new Error('package.json was not found. Configure Jenkins to build the project root and the master branch.');
  }
